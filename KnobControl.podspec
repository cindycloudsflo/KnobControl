...
spec.homepage     = "http://raywenderlich.com"
  ...
  spec.author             = { "Cindy Zhang" => "czhang@threatmetrix.com" }
  # Or just: spec.author    = "Cindy Zhang"
  # spec.authors            = { "Cindy Zhang" => "czhang@threatmetrix.com" }
  # spec.social_media_url   = "https://twitter.com/Cindy Zhang"
  ...
  spec.source       = { :git => "https://github.com/cindycloudsflo/KnobControl.git", :tag =>"1.0.0"}
#spec.source       = { :path => '.' }
